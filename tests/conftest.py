# any fixtures define in this file will be accesible to any test within the package
import pytest
...
def test_user(client):
    user_data = {"email": "pytest@example.com", "password": "password123"}
...
def test_user2(client):
    user_data = {"email": "pytest12123@example.com", "password": "password123"}
    res = client.post("/users/", json=user_data)
    new_user = res.json()
    new_user["password"] = user_data["password"]
    assert res.status_code == 201
